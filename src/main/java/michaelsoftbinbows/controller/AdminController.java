...
public class AdminController {
  ...
  public String mostrarPanelAdmin(
    ...
    if (correoAEditar != null) {
      System.out.println(
          "DEBUG: Se ha solicitado abrir el modal para editar al usuario: " + correoAEditar);
  ...
  /**
   * Endpoint para forzar un reseteo manual de la temporada (puntos de liga). Solo accesible por
   * administradores.
   *
