...
/**
 * Clase de utilidad que maneja la lógica de cálculo de experiencia (EXP) necesaria para subir de
 * nivel.
 */
public class SistemaNiveles {

  /**
   * Recibe el nivel que se desea alcanzar y devuelve la experiencia necesaria para ello. La fórmula
   * cambia para que los primeros niveles sean más rápidos y los niveles posteriores requieran más
   * esfuerzo.
   *
