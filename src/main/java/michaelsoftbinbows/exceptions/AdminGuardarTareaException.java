...
/**
 * Excepción lanzada cuando el Admin hace una edición de Tarea inválida.
 *
 * <p>Utilizada por el GlobalExceptionManager.
 *
 * <p>Guarda 3 atributos como contexto para que el estado de la pantalla previo al error se
 * mantenga.
 */
