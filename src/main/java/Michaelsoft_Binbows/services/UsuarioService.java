...
public class UsuarioService {
    ...
    public Usuario guardar(Usuario usuario) throws EdicionInvalidaException, RegistroInvalidoException {
    ...
    public Usuario guardarSinValidarContraseña(Usuario usuario) {
    ...
    public void actualizarUsuario(String correoOriginal, String nuevoNombre, String nuevoCorreo, Rol nuevoRol) throws RegistroInvalidoException {
        ...
        if (nuevoNombre == null || nuevoNombre.trim().isEmpty() || nuevoNombre.length() < 3 || nuevoNombre.length() > 30) {
    ...
    public void actualizarContraseñaUsuario(String correo, String nuevaContraseña) throws RegistroInvalidoException {
