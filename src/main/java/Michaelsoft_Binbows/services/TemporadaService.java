...
public class TemporadaService {
    ...
    /**
     * El reseteo automático.
     * El 'cron' está puesto para ejecutarse a las 00:00 del día 1 de cada mes.
     * * Para testear, cambiar temporalmente a:
    ...
    /**
     * Esta es la función que llamará el Admin para probar.
     * Simplemente llama al mismo método de reseteo.
     */
    @Transactional
