...
public class PerfilController {
  ...
  public String mostrarPerfil(Model model) {
    ...
    String correo =
        userDetails.getUsername(); // Si tu CustomUserDetails usa el correo como username
  ...
  public String cambiarContrasena(
    ...
    if (contrasenaActual == null
        || contrasenaActual.trim().isEmpty()
        || contrasenaNueva == null
        || contrasenaNueva.trim().isEmpty()
        || contrasenaRepetida == null
        || contrasenaRepetida.trim().isEmpty()) {
    ...
    try {
      ...
      System.out.println(
          "LOG: Contraseña actualizada exitosamente para: " + usuarioActual.getNombreUsuario());
  ...
  public String borrarCuenta(HttpSession session, Model model) {
    ...
    try {
      ...
      // Clear Spring Security context and invalidate the HTTP session
