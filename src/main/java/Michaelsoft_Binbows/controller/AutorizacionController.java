...
public class AutorizacionController {
  ...
  @Autowired private Michaelsoft_Binbows.services.UsuarioService usuarioService;
  ...
  public String login(@RequestParam String email, @RequestParam String password) {
    ...
    // 3. We don't store user in HttpSession; rely on Spring Security Authentication
