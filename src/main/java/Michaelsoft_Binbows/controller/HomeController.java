...
public class HomeController {
  ...
  public String mostrarHome(Model model) {
    ...
    // List<Tarea> tareas = usuarioActual != null ?usuarioActual.getTareas() :
    // Collections.emptyList();
    model.addAttribute("tareas", tareas);

    List<Tarea> tareasCompletadas =
        usuarioActual != null ? usuarioActual.getTareasCompletadas() : Collections.emptyList();
    tareasCompletadas.sort(
