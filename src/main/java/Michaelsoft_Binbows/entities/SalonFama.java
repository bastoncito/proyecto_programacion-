...
public class SalonFama {
    ...
    public SalonFama(int puesto, String temporadaNombre, String nombreUsuario, int puntos, String liga) {
        this.puesto = puesto;
    ...
    public void setTemporadaNombre(String temporadaNombre) { this.temporadaNombre = temporadaNombre; }
