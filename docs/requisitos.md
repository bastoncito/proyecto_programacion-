...
- **Sistema de niveles y logros:** los usuarios poseerán un nivel el cual se subirá mediante puntos o experiencia, además de contar con logros los cuales piden cumplir ciertos desafíos y recompensan al usuario con experiencia.
- **Ranking global:** la aplicación contará con un ranking global el cual permitirá ver a las personas con mayor nivel en la aplicación.
- **Sistema de perfiles:** los usuarios podrán decidir si mantener su perfil publico/solo amigos/privado, en el perfil se mostrará el nivel y logros del usuario.
- **Recordatorios:** la aplicación podrá mandar notificaciones al usuario sobre tareas que están por vencer o recomendar hacer tareas específicas.
- **Generar resúmenes:** debe ser capaz de generar resúmenes para ver el progreso semanal o mensual.
